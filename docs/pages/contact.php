...
$yourWebsite = "martinpc.co.uk"; // the name of your website
...
?>
            ...
            <div class="wrapper">
                <form action="<?php echo basename(__FILE__); ?>" method="post" id="enquiryform">
                    <noscript>
                        <p>
                        ...
                        <select name="reason" id="reason" form="enquiryform">
                            <option value="type">I found a typo</option>
                            <option value="suggestion">I have a suggestion</option>
                            <option value="general" selected="selected">General - Other</option>
                        </select>
                        <br />
                        <br />

                        <label for="comments">Message: *</label>
                        <textarea name="comments" id="comments" rows="6" cols="30" onfocus="this.value=''; this.onfocus=null;">
